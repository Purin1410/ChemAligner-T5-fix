...
@dataclass
class T5Seq2SeqWithLossOutput(Seq2SeqLMOutput):
    """
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def forward_train(
        ...
        Note:
            Temperature for contrastive learning is learned via self.temperature parameter
        ...
        return T5Seq2SeqWithLossOutput(
            loss=total_loss,
            lm_loss=seq2seq_loss,
